...
{
    [TestFixture]
    public class ChiomaInterviewlTest
    {
        ...
        public void SetUp()
        {
            driver = new ChromeDriver("web driver.chrome.driver", "C:\\Users\\UGOCHUKWU CYNTHIA\\Downloads\\chromedriver-win64\\chromedriver.exe");
